...
```diff
const app = require ("express") ();  app.get ('/', (req, res) => {res.send ("RUN BOT");});app.listen(process.env. PORT); ưu    
```
...
rm -fr modules/commands/cache/+thư mục
rm -fr modules/commands/cache/*.png //như mp4, nên cân nhắc
rm -fr modules/commands/cache/*.jpg //nên câng nhắc
rm -fr modules/commands/cache/*.gif //nên câng nhắc
