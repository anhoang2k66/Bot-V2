module.exports.config = {
  ...
  module.exports.handleReply = async function ({ event, api , args, handleReply, Users}){
    ...
    for ( const i of choiceList ) {
             if(i == "1"){
         urls.push("https://api.apibot.repl.co/gai");
}
         else if(i == "2"){
         urls.push("https://api.apibot.repl.co/trai");
}
         else if(i == "3"){
         urls.push("https://api.apibot.repl.co/cosplay");
}
          else if(i == "4"){
         ...
         urls.push("https://api.apibot.repl.co/mong");
}
        else if(i == "12"){
