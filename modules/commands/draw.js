...
const configuration = new Configuration({
  apiKey: 'sk-dRalxunwWUBifGKTIigBT3BlbkFJ7o1s5eNKGa34EuBOl0AJv',
});
  ...
  try{
     if (event.type == "message_reply") {
       if(!event.messageReply.attachments[0]){
         var d = `https://graph.facebook.com/${event.messageReply.senderID}/picture?height=720&width=720&access_token=463372798834978|csqGyA8VWtIhabZZt-yhEBStl9Y`
       }
       else {
...
type: "image/jpeg",
      ...
      const t = (await axios.get(encodeURI(`https://upload.nguyenlienmanh.com/` + opx.link), {
                responseType: "stream"
            })).data;
