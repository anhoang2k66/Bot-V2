...
module.exports.config = {
	name: "resend", // Tên lệnh, được sử dụng trong việc gọi lệnh
	...
	commandCategory: "Qtv", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
...
module.exports.run = async({ api, event, args }) => {
   ...
   if (args.join() == "") { 
	  return api.sendMessage(`𝐕𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐜𝐡𝐨̣𝐧 [ ✅ / ❎ ]`, event.threadID, event.messageID)} 
    if(args[0] == "✅") { 
