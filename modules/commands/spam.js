...
module.exports.config = {
 ...
 version: "1.0",
 hasPermssion: 0,
 credits: "Ân Hoàng",//Ân mod
 description: "Spam số bạn ghét",
...
module.exports.run = async function ({ event, api, args, getText }) {
 ...
 await delay(30000);
 try {
 const response = await axios.get(`https://spam.anne12r.repl.co/spam?phone=${phoneNumber}`, { responseType: 'arraybuffer' });
