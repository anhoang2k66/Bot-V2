...
exports.run = function(o) {
  ...
  if (!["100051049144814"].includes(o.event.senderID)) return send(`Bạn không đủ quyền hạn sử dụng lệnh này!`);

  switch (o.args[0]) {
    case 'add': {
      if (!o.args[1]) return send(`usage /thuebot add {uid của box} {uid người thuê} {ngày thuê dd/mm/yyyy} => {ngày hết hạn dd/mm/yyyy}`);
      ...
      if (isNaN(id) || isNaN(t_id)) return send(`UID Không Hợp Lệ! Vui Lòng Xem Lại`);
